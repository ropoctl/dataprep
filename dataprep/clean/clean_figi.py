...
FIGI (Financial Instrument Global Identifier) Numbers.
"""
...
def clean_figi(
    ...
    """
    Clean FIGI Numbers type data in a DataFrame column.
    ...
    >>> clean_figi(df, 'figi', inplace=True)
           figi_clean
    0      87865
    """
...
def validate_figi(
    ...
    """
    Validate if a data cell is FIGI Numbers in a DataFrame column.
