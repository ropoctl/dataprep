...
def clean_casrn(
    ...
    """
    Clean CAS Registry Numbers type data in a DataFrame column.
    ...
    >>> clean_casrn(df, 'casrn', inplace=True)
           casrn_clean
    0      87865
    """
...
def validate_casrn(
    ...
    """
    Validate if a data cell is CAS Registry Numbers in a DataFrame column.
