...
def clean_ean(
    ...
    """
    Clean EAN numbers type data in a DataFrame column.
    ...
    ----------
        ...
        column
            The name of the column containing data of EAN type.
        output_format
    ...
    Examples
    --------
    Clean a column of EAN numbers data.
...
def validate_ean(
    ...
    """
    Validate if a data cell is EAN numbers in a DataFrame column.
