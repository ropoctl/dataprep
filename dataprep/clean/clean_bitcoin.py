...
def clean_bitcoin(
    ...
    """
    Clean Bitcoin address type data in a DataFrame column.
    ...
    >>> clean_bitcoin(df, 'bitcoin', inplace=True)
           bitcoin_clean
    0      1NEDqZPvTWRaoho48qXuLLsrYomMXPABfD
    1      bc1qardv855yjngspvxuttq897aqca3lxju2y69jce
    """
...
def validate_bitcoin(
    df: Union[str, pd.Series, dd.Series, pd.DataFrame, dd.DataFrame],
    column: str = "",
) -> Union[bool, pd.Series, pd.DataFrame]:
    """
    Validate if a data cell is Bitcoin Address in a DataFrame column.
