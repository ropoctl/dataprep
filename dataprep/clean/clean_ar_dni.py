...
def clean_ar_dni(
    ...
    """
    Clean Argentinian DNI type data in a DataFrame column.
    ...
    ----------
        ...
        column
            The name of the column containing data of Argentinian DNI type.
        output_format
    ...
    >>> clean_ar_dni(df, 'ar_dni', inplace=True)
           ar_dni_clean
    0       20.123.456
    1       20.123.456
    2           NaN
