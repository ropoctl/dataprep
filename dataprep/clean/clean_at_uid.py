...
def clean_at_uid(
    ...
    """
    Clean Austrian UID type data in a DataFrame column.
    ...
    ----------
        ...
        column
            The name of the column containing data of Austrian UID type.
        output_format
    ...
    >>> clean_at_uid(df, 'at_uid', inplace=True)
           at_uid_clean
    0       U13585627
    1           NaN
    """
