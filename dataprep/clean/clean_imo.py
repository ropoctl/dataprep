...
def clean_imo(
    ...
    """
    Clean IMO Numbers type data in a DataFrame column.
...
def validate_imo(
    ...
    """
    Validate if a data cell is IMO Numbers in a DataFrame column.
...
def _format(
    ...
    if output_format == "compact":
        result = [imo.compact(val)] + result
    elif output_format == "standard":
        result = [imo.format(val)] + result
